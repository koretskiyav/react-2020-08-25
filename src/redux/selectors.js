...
export const firstLoadedRestaurantIdSelector = createSelector(
  restaurantsListSelector,
...
export const submitBodySelector = createSelector(orderSelector, (order) =>
  Object.keys(order).reduce((acc, productId) => {
